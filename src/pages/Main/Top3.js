  ...
  return (
    ...
    <div className="row">
      <div className="container">
        <h1 style={{fontSize: 50, letterSpacing: 8, color: 'red', marginLeft: 35}}>
          <span>
        ...
        <div className="col s12">
          <div className="col l8 s12">
            <div className="video-container">
              <iframe title="videoTop3" width="853" height="480" src={videoExecucao ? videoExecucao.link : null} frameBorder="0" allowFullScreen></iframe>
            </div>
          </div>
            ...
            <ul>
              {top3.map((el, indice) => (
                <li style={{display: 'flex', marginTop: 15, alignItems: 'stretch', borderBottom: 'dotted 1px rgba(0,0,0,0.7)'}} className="col s12">
                  ...
                  <span style={{padding: 0}}> <span style={{padding: 0}}>{el.artista}</span> 
                    <br/> 
                  <span style={{fontSize: 25, fontWeight: 700, padding: 0}}>{el.musica}</span></span>
                </li>
              ))}              
            </ul>
          </div>
